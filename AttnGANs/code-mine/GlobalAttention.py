...
def func_attention(query, context, gamma1):
    """
    query: batch x gf_dim x queryL
    context: batch x gf_dim x ih x iw (sourceL=ihxiw)
    ...
    # Get attention
    # (batch x sourceL x gf_dim)(batch x gf_dim x queryL)
    ...
    # (batch x gf_dim x sourceL)(batch x sourceL x queryL)
    # --> batch x gf_dim x queryL
    weightedContext = torch.bmm(context, attnT)

    # print(attn,weightedContext)
