...
class TextDataset(data.Dataset):
    ...
    def build_dictionary(self, train_captions, val_captions, test_captions):
        ...
        return [train_captions_new, val_captions_new, test_captions_new, ixtoword, wordtoix, len(ixtoword)]
    ...
    def load_text_data(self, data_dir, split):
        ...
        if os.path.isfile(filepath):
            ...
            train_captions, val_captions, test_captions, ixtoword, wordtoix, n_words = self.build_dictionary(train_captions, val_captions, test_captions)
            with open(filepath, 'wb') as f:
                pickle.dump([train_captions, val_captions, test_captions, ixtoword, wordtoix], f, protocol=2)
